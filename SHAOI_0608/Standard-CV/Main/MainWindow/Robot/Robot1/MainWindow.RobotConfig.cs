    ...
    partial class MainWindow
    {
        ...
        public override void ConfigRobot_Task()
        {
            try
            {
                ...
                {
                    StationDataManager.StationDataMngr.PlacePos_L[i].DblValue4 = Protocols.ConfPlaceAngle;
                }
                ...
                ShowState("发送抛料位置：" + Protocols.BotDumpPos);
                LogicRobot.L_I.ParRobotCom_P4L.Add(Protocols.BotDumpPos);
